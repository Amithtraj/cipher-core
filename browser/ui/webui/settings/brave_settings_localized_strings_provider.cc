...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"braveOriginLocalAiToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_LOCAL_AI_TOGGLE_TITLE},
  ...
  // Search settings
      ...
      {"allowElementBlockerInPrivateModeLabel",
       IDS_BRAVE_SHIELDS_ALLOW_ELEMENT_BLOCKER_IN_PRIVATE_LABEL},
      {"allowElementBlockerInPrivateModeSubLabel",
