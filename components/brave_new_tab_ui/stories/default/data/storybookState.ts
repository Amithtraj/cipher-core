...
export const useNewTabData = (state: NewTab.State = defaultState) => {
  const result: NewTab.State = {
    ...
    featureFlagCipherNTPSponsoredImagesWallpaper: true,
    featureCustomBackgroundEnabled: true,
    featureFlagCipherNewsPromptEnabled: true,
    featureFlagCipherNewsFeedV2Enabled: false,
    ...
    showCipherTalk: boolean('Show Brave Talk?', true),
    ...
    isCipherNewsOptedIn: boolean('Brave News opted-in?', false),
